...
function numberDecoderFactory(input) {
  ...
  return {
    decode(bytes, offset = 0) {
      codecsCore.assertByteArrayIsNotEmptyForCodec(codecData.description, bytes, offset);
      codecsCore.assertByteArrayHasEnoughBytesForCodec(codecData.description, input.size, bytes, offset);
